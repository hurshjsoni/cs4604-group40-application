...
export default function AuthPage() {
  ...
  const showAdminRole = mode === "signin";
  ...
  */
  ...
  // While auth is loading or user is already authenticated, show a spinner
  // instead of the login form to prevent interaction with the form.
  if (isLoading || isAuthenticated) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#0d0820]">
