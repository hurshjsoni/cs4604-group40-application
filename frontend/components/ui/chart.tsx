...
type TooltipPayloadItem = { name?: string; dataKey?: string; value?: any; color?: string; payload?: any; fill?: string }
...
const ChartLegendContent = React.forwardRef<HTMLDivElement, ChartLegendContentProps>(
  (
    ...
    return (
      ...
      >
        {payload.map((item) => {
          // When nameKey is provided (e.g. for PieChart), item.value holds the
          // actual data value (e.g. "students") which maps to a config key.
          // Otherwise fall back to item.dataKey.
